                                    ...
                                    <div class="flex items-center">
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center text-sm text-gray-500 mb-1">
                                                <span
                                                    class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs mr-2">Web
                                                    Development</span>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="min-w-0 flex-1">
                                            <div class="flex items-center text-sm text-gray-500 mb-1">
                                                <span
                                                    class="bg-blue-100 text-blue-800 px-2 py-1 rounded-md text-xs mr-2">React</span>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#javascript</span>
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#react</span>
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#webdev</span>
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#typescript</span>
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#css</span>
                                        <span
                                            class="bg-gray-100 text-gray-800 px-2 py-1 rounded-full text-xs">#performance</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="space-y-3">
                                        <div class="text-sm">
                                            <p class="text-gray-900 font-medium">"Great article! WebAssembly is really
                                                changing the game."</p>
                                            <p class="text-gray-500">Sarah Johnson on <a href="#"
                                                    class="text-blue-600">The Future of Web Development</a></p>
                                        </div>
                                        <div class="text-sm">
                                            <p class="text-gray-900 font-medium">"The new concurrent rendering is a
                                                game
                                                changer."</p>
                                            <p class="text-gray-500">Michael Chen on <a href="#"
                                                    class="text-blue-600">React 18 Features</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
